class GridSpriteAnimation extends Phaser.Scene {
    constructor() {
        super();
    }

    preload() {
        this.load.image('bg', '..../images/map1gamescene1.png');
        this.load.spritesheet('spsh1', '..../images/spritesheet2.png', { frameWidth: 64, frameHeight: 112 });
    }
