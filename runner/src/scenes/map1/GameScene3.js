...
export default class GameScene3 extends BaseGameScene {
    ...
    create() {
        ...
        try {
            ...
            setTimeout(() => {
                this.scene.start('map1gamescene3');
            }, 2000);
        }
    }
    ...
    showQuestion(question, iconSprite) {
        ...
        Object.entries(question.options).forEach(([key, value]) => {
            ...
            option.addEventListener('click', () => {
                ...
                iconSprite.disableInteractive(); // This is the correct method to disable interaction
                ...
                setTimeout(() => {
                    ...
                    if (this.answeredQuestions === 5) {
                        ...
                        setTimeout(() => {
                            this.scene.start('space_invaders', { nextScene: 'map1gamescene4' });
                        }, 3000);
                    }
                }, 2000);
            });
