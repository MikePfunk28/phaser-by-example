...
export default class Map3GameScene3 extends BaseGameScene {
    constructor() {
        super({ key: 'map3scene3' });
        this.player = null;
        this.score = 0;
        this.scoreText = null;
        this.currentMap = 3;
    ...
    preload() {
        this.load.scene('map3gamescene3', getAssetPath('images/map3gamescene3.png'));
    ...
    create() {
        ...
        try {
            ...
            setTimeout(() => {
                this.scene.start('map3gamescene3');
            }, 2000);
        }
    }
            ...
            option.addEventListener('click', () => {
                ...
                setTimeout(() => {
                    ...
                    if (this.answeredQuestions === 5) {
                        ...
                        setTimeout(() => {
                            this.scene.start('space_invaders', { nextScene: 'map3gamescene4' });
                        }, 3000);
                    }
                }, 2000);
            });
