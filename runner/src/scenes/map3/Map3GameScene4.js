...
export default class Map3GameScene4 extends Phaser.Scene {
    ...
    preload() {
        this.load.scene('map3gamescene4', getAssetPath('images/map3gamescene4.png'));
    ...
    create() {
        ...
        try {
            ...
            setTimeout(() => {
                this.scene.start('map3gamescene4');
            }, 2000);
        }
    }
            ...
            option.addEventListener('click', () => {
                ...
                setTimeout(() => {
                    ...
                    if (this.answeredQuestions === 5) {
                        ...
                        setTimeout(() => {
                            this.scene.start('space_invaders', { nextScene: 'map4gamescene1' });
                        }, 3000);
                    }
                }, 2000);
            });
