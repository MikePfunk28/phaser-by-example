...
export default class Map4GameScene3 extends BaseGameScene {
    constructor() {
        super({ key: 'map4scene3' });
        this.player = null;
        this.score = 0;
        this.scoreText = null;
        this.currentMap = 4;
            ...
            option.addEventListener('click', () => {
                ...
                setTimeout(() => {
                    ...
                    if (this.answeredQuestions === 5) {
                        ...
                        setTimeout(() => {
                            this.scene.start('space_invaders', { nextScene: 'map4scene4' });
                        }, 3000);
                    }
                }, 2000);
            });
