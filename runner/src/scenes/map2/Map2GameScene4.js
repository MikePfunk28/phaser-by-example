...
export default class Map2GameScene4 extends Phaser.Scene {
    constructor() {
        super({ key: 'map2_game4' });
        this.player = null;
        this.score = 0;
        this.scoreText = null;
        this.currentMap = 1;
    ...
    preload() {
        this.load.image('map2scene4', getAssetPath('images/map2scene4.png'));
            ...
            option.addEventListener('click', () => {
                ...
                setTimeout(() => {
                    ...
                    if (this.answeredQuestions === 5) {
                        ...
                        setTimeout(() => {
                            this.scene.start('space_invaders', { nextScene: 'map3_game1' });
                        }, 3000);
                    }
                }, 2000);
            });
