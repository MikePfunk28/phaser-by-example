...
export default class Map2GameScene3 extends Phaser.Scene {
    ...
    preload() {
        this.load.image('map2scene3', getAssetPath('images/map2scene3.png'));
            ...
            option.addEventListener('click', () => {
                ...
                setTimeout(() => {
                    ...
                    if (this.answeredQuestions === 5) {
                        ...
                        setTimeout(() => {
                            this.scene.start('space_invaders', { nextScene: 'map2_game4' });
                        }, 3000);
                    }
                }, 2000);
            });
